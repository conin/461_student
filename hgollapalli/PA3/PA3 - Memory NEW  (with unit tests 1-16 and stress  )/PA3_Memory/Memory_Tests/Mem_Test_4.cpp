...
{
	io::create("Student Values", "Test4");

	fprintf(io::getHandle(),"Test4: \n\n");

	fprintf(io::getHandle()," 1) allocate regular size block              \n");

	fprintf(io::getHandle(),"     memSystem mem;                          \n");
	fprintf(io::getHandle(),"     mem.InitializeSystem();                 \n");
   	fprintf(io::getHandle(),"     void *p = mem.Malloc( 200 );            \n");
