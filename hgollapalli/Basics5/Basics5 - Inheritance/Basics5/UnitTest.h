...
public:
	...
	static void RunTests()
	{
		...
		while (pTmp != 0)
		{
			...
			pTest->testFunc->run(pRegistry->tr_data, pRegistry->tr_stats);
...
{ \
	...
	\
	void run(UnitData &, UnitStats &);\
} TestName##GroupName##_instance; \
\
void TestName##GroupName##_Test::run( UnitData &tr_data, UnitStats &tr_stats ) 
